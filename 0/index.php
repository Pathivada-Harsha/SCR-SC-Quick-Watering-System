...
<head>
  <style>
    * {
    ...
    .timestamp-value {
      color: #00468C;
      /* Deep blue that contrasts well with the amber gradient */
      font-weight: 600;
      /* Making it semi-bold for better visibility */
    }
  </style>
                  ...
                  <div class="grid-layout">
                    <div class="grid-item grid-item-color ">
                      ...
                      <div class="item-status">
                        <div id="motor-1-status" class="badge-danger"><i class="bi bi-power"></i> OFF</div>
                      </div>
