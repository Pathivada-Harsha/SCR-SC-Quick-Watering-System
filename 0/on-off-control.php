            ...
            <div class="card shadow ">
              <div class="card-body">
                ...
                <p class="text-left text-muted mt-3">
                  <small class="text-danger"> <b>Note:</b> The device operates in one of the above modes to turn the Motors on or off. All modes do not operate simultaneously.</small>
                </p>
