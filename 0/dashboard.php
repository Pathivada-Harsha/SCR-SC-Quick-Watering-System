              ...
              <div class="row">
                <div class="col-xl-6 ">
                  <div class="card h-100 shadow-sm text-left p-2">
                    <p class="d-flex align-items-center"> <i class="bi bi-lamp-fill h4"></i> Installed Motors: <span><span class="h3 ms-4 text-primary-emphasis" id="installed_lights"> 2562</span> </span>
                    </p>
                    <div class="progress">
