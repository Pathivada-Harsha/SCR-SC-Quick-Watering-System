<?php
$normal='class="text-center"';
$red='class="text-center text-danger fw-bold"'; 
$orange='class="text-center text-warning fw-bold"'; 
$green='class="text-center text-success fw-bold"'; 
$class_r=$normal;
$class_y=$normal;
$class_b=$normal;
$class_ir=$normal;
