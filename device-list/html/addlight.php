    ...
    <div class="modal-dialog ">
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="addLightModalLabel">Add Motor</h5>
            ...
            <div class="modal-body">
                ...
                <form id="addLightsForm">
                    ...
                    <div class="mb-3">
                        <label for="lights" class="form-label">Number of Motors</label>
                        <input type="number" class="form-control" id="lights" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="saveLightButton" onclick="addLight()">Save Motor</button>
