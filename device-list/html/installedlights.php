    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="lightsModalLabel">Installed Motors</h5>
                    ...
                    <table class="table table-striped styled-table w-100 text-center">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-primary-subtle">Total Motors</th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="addLightButton" onclick="showAddLightsForm()">Add Motor</button>
            </div>
        </div>
    </div>
</div>
